        ...
        FineTuneGroup(
            ...
            items = listOf(
                ...
                FineTuneItem(
                    ...
                    valueRange = 50..200,
                    valueRepresentation = { "${it}%" },
                    hint = "Control the length of swipes. This is multiplied with the number of pixels " +
                            "to swipe over. Use along with swipe duration to tweak it to your needs."
                )
            )
        ),
        FineTuneGroup(
        ...
        FineTuneGroup(
            ...
            items = listOf(
                ...
                FineTuneItem(
                    ...
                    valueRange = 0..2000,
                    valueRepresentation = { "${it}ms" },
                    hint = "Delay before the skill sequence starts after Battle screen is detected. " +
                            "Slower devices might need longer delay."
                ),
                FineTuneItem(
                    ...
                    valueRange = 0..6000,
                    valueRepresentation = { "${it}ms" },
                    hint = "Delay between clicking on Attack button and clicking on face-cards/NP. " +
                            "Slower devices might need longer delay."
                ),
                FineTuneItem(
                    ...
                    valueRange = 50..200,
                    valueRepresentation = { "${it}%" },
                    hint = "This multiples to every wait/delay. So, you can make the overall " +
                            "script slower/faster by using this."
                )
            )
        )
    )
