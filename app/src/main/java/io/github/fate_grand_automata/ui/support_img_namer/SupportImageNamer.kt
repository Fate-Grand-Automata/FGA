...
private fun getSupportEntries(
    ...
    val ce6 = SupportImgEntry(
        SupportImageMaker.getCeImgPath(
            tempDir,
            6
        ),
        SupportImageKind.CE,
        frame.findViewById(R.id.support_img_ce_6)
    )
    val ce7 = SupportImgEntry(
        SupportImageMaker.getCeImgPath(
            tempDir,
            7
        ),
        SupportImageKind.CE,
        frame.findViewById(R.id.support_img_ce_7)
    )
    ...
    return listOf(servant0, servant1, ce0, ce1, ce2, ce3, ce4, ce5, ce6, ce7, friend0, friend1)
}
