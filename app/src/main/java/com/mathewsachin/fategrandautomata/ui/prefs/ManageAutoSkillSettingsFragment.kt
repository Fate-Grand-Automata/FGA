...
import com.mathewsachin.fategrandautomata.ui.ManageAutoSkillActivity
import com.mathewsachin.fategrandautomata.util.AutoSkillEntry

class ManageAutoSkillSettingsFragment : PreferenceFragmentCompat() {
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>(getString(R.string.pref_autoskill_manage))?.let {
            it.setOnPreferenceClickListener {
                startActivity(Intent(activity, ManageAutoSkillActivity::class.java))
                true
            }
        }
