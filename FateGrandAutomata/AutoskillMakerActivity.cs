...
namespace FateGrandAutomata
{
    ...
    public class AutoskillMakerActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle SavedInstanceState)
        {
            ...
            enemyTargetGroup.CheckedChange += OnEnemyTargetGroupOnCheckedChange;

            SetupOrderChange();
        }

        void OnEnemyTargetGroupOnCheckedChange(object S, RadioGroup.CheckedChangeEventArgs E)
        {
            if (!(S is RadioGroup group && @group.FindViewById<RadioButton>(E.CheckedId) is { } radioBtn)) return;
